...
DECLARE
    ...
    -- New implementations increment this marker so older pods retain compatible newer functions.
...
BEGIN
    ...
    FOR attempt IN 1..2 LOOP
        ...
        IF function_version > implementation_version AND (NOT function_ready OR missing_columns) THEN
